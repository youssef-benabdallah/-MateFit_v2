...
// @ts-ignore
export default function EventPost({navigation}) {
    ...
    const show_price_input = () => {
        return [<Text key={'TextPrice'}>Price</Text>,
            <TextInput key={'Price'}
                       onChangeText = {
                           (Price)=> {
                               // @ts-ignore
    ...
    return (
        ...
        <View key={'View1'} style={styles.container}>
            ...
            <Text></Text>
            <Text style={styles.title}>Event Post</Text>
            ...
            >
                ...
                {show_price_input()}
                <Button key={'PostActivtyButton'} onPress={PostActivty} title='Post Event'></Button>
            </ScrollView>
